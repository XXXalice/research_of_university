...
base_image_path = os.path.join('./img',bp.USE_FOLDER)
base_image = os.path.join('./img', bp.USE_FOLDER, bp.USE_IMAGE+'.jpg')
...
save_img(img, fname=base_image_path + '/' + bp.USE_IMAGE + '_nightmare.png')